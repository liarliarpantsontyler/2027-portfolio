...
export const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      },
      {
        ...
        width: 1170,
        height: 2532,
        alt: "Klocky onboarding setting Chicago time, choosing a clock, and revealing the finished display",
      ...
      },
      {
        ...
        width: 2532,
        height: 1170,
        alt: "Sunday clock as its controls fade away, leaving the animated display",
  ...
  },
  {
    ...
    headline: "Turning subscription management into a revenue channel",
    intro:
      "Oats Overnight had hundreds of thousands of active subscriptions, but its logged-in experience wasn't naturally a shopping destination. I designed a cross-sell and upsell system that introduced relevant purchase opportunities into existing customer behavior instead of waiting for customers to go looking for them.",
    capabilities: "Product design · Growth design",
    theme: "oats",
    year: "2026",
    outcomes: [
      {
        value: "~70%",
        label: "of logged-in users took no measurable action",
        context: "Precise event definition and source still to be documented.",
        status: "reported",
      },
      {
        value: "+$215K",
        label: "estimated incremental revenue (~5 months)",
        context: "Placeholder estimate — replace with production calculation before final publish.",
        status: "scope",
      },
      {
        value: "~14%",
        label: "offer acceptance from eligible exposures",
        context: "Placeholder until production conversion data is wired in.",
        status: "scope",
      },
    ],
    resultNote:
      "Revenue figure is an estimated placeholder (eligible exposures × incremental conversion × incremental order value). Replace with sourced analytics before claiming incrementality.",
    role: "Tyler led product and growth design for the cross-sell and upsell system, from the initial pack-size ask through offer logic, placement, and in-app experiences.",
    gallery: [
      {
        src: "/work/oats-shop-motion.mp4",
        width: 1942,
        height: 1594,
        alt: "Cross-sell and shop opportunities inside the Oats Overnight subscription portal",
        title: "",
        caption: "",
        treatment: "edge",
        kind: "video",
      ...
      },
      {
        ...
        width: 2000,
        height: 759,
        alt: "Flavor announcement, Protein Coffee offer, and shop categories in the portal",
        title: "",
        caption: "",
        treatment: "edge",
      },
      ...
      {
        src: "/work/oats-cross-sell/pack-ladder.webp",
        width: 1170,
        height: 2532,
        alt: "Pack-size subscription ladder from 8 through 32 meals",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
        placeholder: true,
        placeholderHint: "Full pack ladder: current state, next step, upgrade confirmation.",
      },
      {
        src: "/work/oats-flavor-builder.webp",
        width: 579,
        height: 1032,
        alt: "Subscription flavor selection with quantities and bundle options",
        title: "",
        caption: "",
        treatment: "device",
        half: true,
      ...
      {
        src: "/work/oats-cross-sell/16-to-24.webp",
        width: 1170,
        height: 2532,
        alt: "16-pack to 24-pack incremental upgrade offer",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
        placeholder: true,
        placeholderHint: "16 → 24 upsell: incremental meals and price framing.",
      },
      {
        src: "/work/oats-cross-sell/8-pack-modal.webp",
        width: 1170,
        height: 2532,
        alt: "8-pack upsell modal in subscription context",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
        placeholder: true,
        placeholderHint: "8-pack modal: trigger moment, eligible state, accept and dismiss outcomes.",
      },
      {
        src: "/work/oats-protein-coffee.webp",
        width: 579,
        height: 1032,
        alt: "Protein Coffee cross-sell with quantities and gifts",
        title: "",
        caption: "",
        treatment: "device",
        half: true,
