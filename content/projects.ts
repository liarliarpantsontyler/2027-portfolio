...
export const projects: Project[] = [
  ...
  },
  {
    ...
    headline: "Making room for discovery.",
    intro: "Turning a subscription-management homepage into a place to discover relevant products, evaluate add-ons, and move into a larger box.",
    capabilities: "Product strategy · End-to-end product design",
    theme: "oats",
    year: "2026",
    presentation: "visual-first",
    role: "Tyler owned product strategy, experience design, offer placement, interaction details, and delivery end-to-end.",
    gallery: [
      {
        src: "/work/oats-cross-sell/homepage.webp",
        width: 786,
        height: 1240,
        alt: "Production mobile homepage with the Protein Coffee discovery offer above order status",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
      ...
      {
        src: "/work/oats-cross-sell/historical-homepage.webp",
        width: 1179,
        height: 1380,
        alt: "Historical Figma reference showing the large loyalty header and coffee carousel",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
      ...
      {
        src: "/work/oats-cross-sell/coffee-builder.webp",
        width: 393,
        height: 852,
        alt: "Production Protein Coffee builder with pack size choices and flavors",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
      ...
      {
        src: "/work/oats-cross-sell/protein-context.webp",
        width: 393,
        height: 852,
        alt: "Protein Pack offer beneath Edit Flavors in the production mobile portal",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
      ...
      {
        src: "/work/oats-cross-sell/protein-details.webp",
        width: 393,
        height: 852,
        alt: "Protein Pack details with monthly recurring terms, cancellation, and quantity choices",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
      ...
      {
        src: "/work/oats-cross-sell/upgrade.webp",
        width: 393,
        height: 852,
        alt: "Production upgrade modal with prefilled flavors, editing controls, and 24 of 24 packs",
        title: "",
        caption: "",
        treatment: "device",
        orientation: "portrait",
